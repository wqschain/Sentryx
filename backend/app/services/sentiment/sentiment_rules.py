...
def apply_sentiment_rules(text: str, model_sentiment: str, model_confidence: float) -> Tuple[str, float]:
    """
    Apply sentiment rules to adjust model predictions.
    
    Args:
        text: The text to analyze
        model_sentiment: The sentiment predicted by the model
        model_confidence: The confidence score from the model
        
    Returns:
        Tuple of (adjusted_sentiment, adjusted_confidence)
    """
    return adjust_sentiment(model_sentiment, model_confidence, text)

def get_sentiment_score(text: str) -> Dict[str, float]:
    """
    Get sentiment scores based on keyword analysis.
    
    Args:
        text: The text to analyze
        
    Returns:
        Dictionary of sentiment scores for each category
    """
    return calculate_keyword_score(text) 